...
This table is empty at scaffolding. It is populated in STEP 5, after the
build order is approved. Session Notes entries are added at each feature's
closeout — do not add any now.
